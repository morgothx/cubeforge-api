...
import { DESCRIBE_VOCABULARY_ROLES } from '../../../application/semantic/describe-vocabulary.use-case';
...
describe('the declared roles and the enforced roles', () => {
  ...
  const ENFORCED: Readonly<Record<string, readonly Role[]>> = {
    ...
    'GET /tenants/:tenantId/analytics/vocabulary': DESCRIBE_VOCABULARY_ROLES,
